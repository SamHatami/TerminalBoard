...
public class WireViewModel : PropertyChangedBase, IWireViewModel, IHandle<SelectItemEvent>
{
    ...
    public IOperator InputOperator { get; set; }
    public IOperator OutputOperator { get; set; }
    public ConduitTypeEnum ConduitType { get; set; }
    public IConduit ConduitConnection { get; set; }
    ...
    {
        InputOperator = start.ParentViewModel.Operator;
        OutputOperator = end.ParentViewModel.Operator;
    }
    ...
    public void SetEndSocket(ISocketViewModel socketViewModel)
    {
        ...
        if (EndSocketViewModel.Type == DataPortDirection.Input)
            EndSocketViewModel.DataPort.IsConnected = true; //Meh...
