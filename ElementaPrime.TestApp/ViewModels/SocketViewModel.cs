...
public class SocketViewModel : PropertyChangedBase, ISocketViewModel, IHandle<TerminalRemovedEvent>, IHandle<WireRemovedEvent>
{
    ...
    public DataPortDirection Type { get; set; }
    ...
    public SocketViewModel(ITerminalViewModel parent, IEventAggregator events, DataPortDirection type, IDataPort dataPort)
    {
